...
$pagename = 'Teeth whitening in Noida'; ?>
<!DOCTYPE html>
<html lang="zxx">
...
<head>
    ...
    <meta name="description" content="Teeth whitening in Noida">
...
<body>
    ...
    <!-- Bleaching and Teeth Whitening Section Start -->
    <div class="service-section pt-5 pb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="section-title wow fadeInUp">Bleaching and Teeth Whitening</h2>
                    <p class="wow fadeInUp" data-wow-delay="0.2s">
                        A bright, white smile can enhance your appearance and boost your confidence. At Shashwat Dental in Noida, Dr. Pooja Srivastava offers professional bleaching and teeth whitening treatments that are safe, effective, and long-lasting. Say goodbye to stains and discoloration caused by coffee, tea, or smoking, and hello to a radiant smile.
                    </p>
                    <p class="wow fadeInUp" data-wow-delay="0.4s">
                        Using advanced whitening technology, Dr. Pooja Srivastava ensures that your teeth are whitened safely, with immediate and noticeable results. Whether you're preparing for a special occasion or just want to enhance your everyday look, our personalized teeth whitening solutions are designed to meet your specific goals.
                    </p>
                    <p class="wow fadeInUp" data-wow-delay="0.6s">
                        Visit Shashwat Dental in Noida for professional teeth whitening treatments that deliver stunning results. Book your consultation with Dr. Pooja Srivastava today and achieve a brighter, more confident smile with our expert bleaching and teeth whitening services.
                    </p>
                </div>
            </div>
        </div>
    </div>
    <!-- Bleaching and Teeth Whitening Section End -->
