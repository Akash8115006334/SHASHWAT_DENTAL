...
$pagename = 'Best General Dentistry in Noida'; ?>
<!DOCTYPE html>
<html lang="zxx">
...
<head>
    ...
    <meta name="description" content="Best General Dentistry in Noida">
...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-2" data-cursor="-opaque"><span>General </span> Dentistry</h1>
    ...
    <!-- General Dentistry Section Start -->
    <div class="service-section pt-5 pb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="section-title wow fadeInUp">General Dentistry</h2>
                    <p class="wow fadeInUp" data-wow-delay="0.2s">
                        At Shashwat Dental in Noida, we provide comprehensive general dentistry services to ensure your oral health is maintained throughout every stage of life. Led by Dr. Pooja Srivastava, our experienced team focuses on prevention, diagnosis, and treatment of a wide range of dental issues to keep your smile healthy and beautiful.
                    </p>
                    <p class="wow fadeInUp" data-wow-delay="0.4s">
                        Our general dentistry services include:
                    <ul class="wow fadeInUp" data-wow-delay="0.6s">
                        <li>**Regular Dental Check-ups:** Comprehensive examinations to detect early signs of dental problems.</li>
                        <li>**Professional Cleanings:** Thorough cleanings to remove plaque and tartar, promoting healthier gums and teeth.</li>
                        <li>**Fillings and Restorations:** Treatment for cavities and damaged teeth using high-quality materials.</li>
                        <li>**Preventive Care:** Education on oral hygiene and preventive measures to maintain optimal dental health.</li>
                        <li>**Child Dentistry:** Specialized care for children, ensuring a positive dental experience from an early age.</li>
                    </ul>
                    </p>
                    <p class="wow fadeInUp" data-wow-delay="0.8s">
                        At Shashwat Dental, we believe that preventive care is key to maintaining a healthy smile. Our friendly and knowledgeable staff is dedicated to providing personalized care in a comfortable environment. Schedule your appointment today with Dr. Pooja Srivastava and take the first step toward achieving excellent oral health.
                    </p>
                </div>
            </div>
        </div>
    </div>
    <!-- General Dentistry Section End -->
