...
$pagename = 'Best Oral Surgical Procedures in Noida'; ?>
<!DOCTYPE html>
<html lang="zxx">
...
<head>
    ...
    <meta name="description" content="Best Oral Surgical Procedures in Noida">
...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-2" data-cursor="-opaque"><span>Oral Surgical </span> Procedures</h1>
    ...
    <!-- Oral Surgical Procedures Section Start -->
    <div class="service-section pt-5 pb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="section-title wow fadeInUp">Oral Surgical Procedures</h2>
                    <p class="wow fadeInUp" data-wow-delay="0.2s">
                        At Shashwat Dental in Noida, we specialize in a variety of oral surgical procedures to address complex dental issues effectively and safely. Led by Dr. Pooja Srivastava, our team is dedicated to providing high-quality care in a comfortable environment, ensuring that each patient feels at ease during their treatment.
                    </p>
                    <p class="wow fadeInUp" data-wow-delay="0.4s">
                        Our oral surgical procedures include:
                    <ul class="wow fadeInUp" data-wow-delay="0.6s">
                        <li>**Tooth Extractions:** Safe removal of damaged or decayed teeth.</li>
                        <li>**Wisdom Tooth Removal:** Expert extraction of wisdom teeth to prevent overcrowding and discomfort.</li>
                        <li>**Bone Grafting:** Procedures to rebuild bone in preparation for implants.</li>
                        <li>**Jaw Surgery:** Surgical interventions to correct jaw alignment and improve functionality.</li>
                        <li>**Oral Biopsies:** Precise tissue removal for diagnostic purposes.</li>
                    </ul>
                    </p>
                    <p class="wow fadeInUp" data-wow-delay="0.8s">
                        Dr. Pooja Srivastava employs the latest techniques and technology to ensure minimal discomfort and a swift recovery for our patients. If you're in need of oral surgical procedures, Shashwat Dental is here to provide compassionate and professional care. Contact us today to schedule your consultation and take the first step towards better oral health.
                    </p>
                </div>
            </div>
        </div>
    </div>
    <!-- Oral Surgical Procedures Section End -->
