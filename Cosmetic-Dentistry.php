...
$pagename = 'Best Cosmetic Dentistry in Noida'; ?>
<!DOCTYPE html>
<html lang="zxx">
...
<head>
    ...
    <meta name="description" content="Best Cosmetic Dentistry in Noida">
...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-2" data-cursor="-opaque"><span>Cosmetic </span> Dentistry</h1>
    ...
    <!-- Cosmetic Dentistry Section Start -->
    <div class="service-section pt-5 pb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="section-title wow fadeInUp">Cosmetic Dentistry</h2>
                    <p class="wow fadeInUp" data-wow-delay="0.2s">
                        Your smile is one of your most important assets, and at Shashwat Dental in Noida, we specialize in enhancing it through advanced cosmetic dentistry. Led by Dr. Pooja Srivastava, our team offers a wide range of cosmetic treatments to help you achieve the perfect smile you’ve always wanted.
                    </p>
                    <p class="wow fadeInUp" data-wow-delay="0.4s">
                        Whether you're looking for teeth whitening, veneers, bonding, or a complete smile makeover, Dr. Pooja Srivastava ensures that every procedure is tailored to your individual needs. Using the latest techniques and materials, we enhance the appearance of your teeth while maintaining a natural look.
                    </p>
                    <p class="wow fadeInUp" data-wow-delay="0.6s">
                        At Shashwat Dental, we believe that everyone deserves to feel confident about their smile. Book a consultation with Dr. Pooja Srivastava today and let us help you enhance your smile with our expert cosmetic dentistry services. Conveniently located in Noida, we offer personalized care that will leave you smiling brighter than ever.
                    </p>
                </div>
            </div>
        </div>
    </div>
    <!-- Cosmetic Dentistry Section End -->
