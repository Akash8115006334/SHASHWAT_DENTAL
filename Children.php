...
$pagename = 'Best Children Dentistry in Noida'; ?>
<!DOCTYPE html>
<html lang="zxx">
...
<head>
    ...
    <meta name="description" content="Best Children Dentistry in Noida">
...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-2" data-cursor="-opaque"><span>Children </span> Dentistry</h1>
    ...
    <!-- Children Dentistry Section Start -->
    <div class="service-section pt-5 pb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="section-title wow fadeInUp">Children Dentistry</h2>
                    <p class="wow fadeInUp" data-wow-delay="0.2s">
                        At Shashwat Dental, we believe that good dental habits start early. Our specialized children's dentistry services in Noida are designed to provide a friendly and comfortable environment for your child. We focus on preventive care to help your child maintain a healthy smile for life.
                    </p>
                    <p class="wow fadeInUp" data-wow-delay="0.4s">
                        From routine check-ups to addressing more specific dental issues like cavities or misaligned teeth, our team of experienced pediatric dentists ensures your child receives the best care. We make every visit fun and engaging, so your child feels at ease throughout their treatment.
                    </p>
                    <p class="wow fadeInUp" data-wow-delay="0.6s">
                        Conveniently located in Noida, Shashwat Dental is committed to providing quality dental care for your entire family. Schedule your child's appointment today and give them the gift of a healthy, happy smile with our expert children's dentistry services.
                    </p>
                </div>
            </div>
        </div>
    </div>
    <!-- Children Dentistry Section End -->
